...
const BottomPage = () => {
  return (
    <div className="max-w-screen relative overflow-hidden ">
        ...
        {/* Bottom 1 */}
        <div className=" w-[100vw] lg:h-[80vh] md:h-[60vh] h-[50vh] flex flex-col justify-center items-center gap-10  mb-[20vh] md:mb-[20vh] lg:mb-[30vh]">
        ...
        {/* Bottom 2 */}
        {/* <div className=" relative w-[100vw] lg:h-[120vh] md:h-[70vh] h-[70vh] bg-[radial-gradient(circle_at_center,#001820,#000000)] flex flex-col justify-center items-center ">
