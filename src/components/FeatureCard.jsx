...
const FeatureCard = ({ number, title, description }) => {
  return (
    <div className="card border-2 border-[#e6e5e5] rounded-2xl bg-[#f4f4f4] hover:bg-white p-6 flex flex-col gap-3 justify-center hover:shadow-lg transition-transform duration-300 hover:-translate-y-2">
